    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_proof', models.FileField(blank=True, null=True, storage=gridfs_storage.storage.GridFSStorage(collection='id_proof'), upload_to='')),
                ('letter_sub_url', models.URLField(blank=True, default='', max_length=500)),
                ('rzp_customer_id', models.CharField(blank=True, default='', max_length=500)),
